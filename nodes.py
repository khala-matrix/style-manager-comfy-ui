...
class GPTImageGenerate:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "base_url": ("STRING", {"default": "https://api.gptsapi.net"}),
    ...
    def generate(self, api_key, base_url, prompt, aspect_ratio, quality, background, n, output_format, poll_interval, timeout, external_text=None):
